...
SpriteRenderer::SpriteRenderer(Shader& shader, unsigned int width, unsigned int height): shader(shader) {
    ...
    glm::vec3 v3;
    shader.setGlmVec3("lightColor", v3 = glm::vec3(1.0f, 1.0f, 1.0f));
    shader.setGlmVec3("lightPos", v3 = glm::vec3(0.0f, 18.0f, 15.0f));
    shader.setGlmVec3("viewPos", v3 = glm::vec3(0.0f, 18.0f, 15.0f));
}
